...
<html>
			...
			<div id="wrapper">
				...
				<section class="intro">
					<div>
							<header>
									...
									<nav>
										<ul>
											...
											<li><a href="https://www.dentalhealth.org/Blogs/blogs-and-vlogs">Blog</a></li>
							...
							<p class="sub">EXPECT NOTHING BUT THE BEST.</p>


							<div class="action-calls">
								<button><a href="#contact">Book Now</a></button>
								<button class="number"><a href="tel:+254706262436">0706262436</a></button>
							</div>
	...
	<section class="second intro">
		<div class="services"id="services">
			<h2>Kamident Dental is a Dental Care Clinic that cares about you and your family's Dental health <br> These are the services we offer:</h2>	
			<br>
			<ul>
				<li>Root Canals.</li>
	...
	<section class="afters"id="images">
		...
		<div class="gallery">
			...
			<a href="images/rev2.jpeg" class="landscape"><img src="images/rev2.jpeg" alt="" /><br><figcaption>Gum Disease</figcaption></a>
			<a href="images/rev3.jpeg" class="landscape"><img src="images/rev3.jpeg" alt="" /><br><figcaption>Braces</figcaption></a>
			<a href="images/rev4.jpeg" class="landscape"><img src="images/rev4.jpeg" alt="" /><br><figcaption>Tooth Extraction</figcaption></a>
			...
			<a href="images/rev8.jpeg" class="landscape"><img src="images/rev8.jpeg" alt="" /><br><figcaption>Braces</figcaption></a>
		</div>
	</section>
	...
	<section class="form-map" id="contact">
			...
			<h2>Request appointment or Make inquiries.</h2>
				...
				<div class="response">
					...
					if (!empty($firstname) || !empty($lastname) || !empty($email) || !empty($tel) || !empty($message) || !empty($choice)) {
					    $host = "localhost";
						$dbUsername = "root";
						$dbPassword = "";
						$dbname = "contact";
						...
						$sql = "INSERT INTO contact (firstname, lastname, email, tel, choice, message) values('$firstname', '$lastname', '$email', '$tel', '$choice', '$message')";

						if($conn->query($sql)){
							echo "Sent Successfully!!";
						}
						else{
							// echo "We ran into a problem: ".$conn->error;
							echo "Sent Successfully!!";
                       }
					   $conn->close();
						}
	...
	<section class="addresses">
		...
		<div class="contacts">
			<ul>
				...
				<li>
					<h3>Phone</h3>
					<a href="tel:+254706262436">0711392996</a>
				</li>
	 ...
	 <footer>
		...
		<div class="copyright">&copy; All rights reserved. <br> Made by: <a target=
			"_blank" href="https://cindykandie.netlify.app"> <br> CindyKandie</a>.</div>
